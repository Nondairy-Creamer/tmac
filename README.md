...
* TMAC works when the fluorophores for the two channels are expressed and measured in the same place and time. Different expression patterns, segmentation, or measuring the channels at differnt times may lead to different motion artifacts in the two channels.
